# -*- coding: utf-8 -*-
"""
Created on Wed Oct 31 10:00:09 2018
...
rf2 = scope_list(9345, 9406)
rf3 = scope_list(9345, 9406)
rf4 = scope_list(8500, 9600)
rf5 = scope_list(8500, 9600)
rf6 = scope_list(9315, 9376)
rf7 = scope_list(9285, 9346)
rf8 = scope_list(9255, 9316)

pw1 = scope_list(50, 1001, step=50)
pw2 = [60, 600]
pw3 = [500, 600]
...
pri2, jitter2 = [250000, 500000], 0.05
pri3 = [500000, 800000, 1250000]
pri4, stagger4 = scope_list(330000, 4000001, 1000), [0.02, 0.04, 0.08]
pri5 = [500000, 1000000]
